...
- Docker 部署文档：`/Users/luoyu15/Documents/work/agentdiy/docs/chrome-annotation-docker-deploy.md`
...
- 已新增 Docker 化部署能力：`docker-compose.yml`（api + mysql）、`server/Dockerfile`、自动迁移入口脚本。
